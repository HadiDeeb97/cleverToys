...
export const onRequest: MiddlewareHandler = async (context, next) => {
  ...
  if (!path.startsWith('/admin')) {
    ...
    const whatsappBubble = `<a class="whatsapp-bubble" href="${whatsappHref}" target="_blank" rel="noopener noreferrer" aria-label="Chat with Clever Toys on WhatsApp" title="Chat with us on WhatsApp"><span class="whatsapp-icon" aria-hidden="true"><svg viewBox="0 0 32 32" role="img" focusable="false"><path d="M16 3.2C9.1 3.2 3.5 8.8 3.5 15.7c0 2.2.6 4.4 1.8 6.3L3.2 28.8l6.9-2.1c1.8 1 3.8 1.5 5.9 1.5 6.9 0 12.5-5.6 12.5-12.5S22.9 3.2 16 3.2Zm0 22.8c-1.9 0-3.8-.5-5.4-1.5l-.4-.2-4.1 1.2 1.2-4-.3-.4c-1-1.6-1.5-3.5-1.5-5.4C5.5 9.9 10.2 5.2 16 5.2s10.5 4.7 10.5 10.5S21.8 26 16 26Zm5.8-7.8c-.3-.2-1.8-.9-2.1-1-.3-.1-.5-.2-.7.2-.2.3-.8 1-.9 1.2-.2.2-.3.2-.6.1-.3-.2-1.3-.5-2.4-1.5-.9-.8-1.5-1.7-1.7-2-.2-.3 0-.5.1-.7.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2 0-.4 0-.6-.1-.2-.7-1.7-.9-2.3-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.5.1-.8.4-.3.3-1 1-1 2.5s1 2.9 1.1 3.1c.1.2 2 3.1 4.9 4.3.7.3 1.3.5 1.7.7.7.2 1.4.2 1.9.1.6-.1 1.8-.7 2.1-1.4.3-.7.3-1.3.2-1.4-.1-.1-.3-.2-.6-.4Z" fill="currentColor"/></svg></span></a>`;
    const whatsappStyles = `<style id="clever-whatsapp-styles">.whatsapp-bubble{position:fixed;left:20px;bottom:20px;z-index:1000;width:58px;height:58px;border-radius:50%;display:grid;place-items:center;background:#25D366;color:#fff;box-shadow:0 10px 26px rgba(15,23,42,.22);text-decoration:none;transition:transform .18s ease,box-shadow .18s ease}.whatsapp-bubble:hover{transform:translateY(-3px);box-shadow:0 14px 30px rgba(15,23,42,.26)}.whatsapp-bubble:focus-visible{outline:3px solid #111827;outline-offset:3px}.whatsapp-icon{width:30px;height:30px;display:grid;place-items:center}.whatsapp-icon svg{width:30px;height:30px}@media(max-width:640px){.whatsapp-bubble{left:14px;bottom:14px;width:54px;height:54px}.whatsapp-icon,.whatsapp-icon svg{width:28px;height:28px}}</style>`;
