...
export const onRequest: MiddlewareHandler = async (context, next) => {
  ...
  // Defer until the document is parsed. store-ui creates floating controls and touches document.body.
  const storeScript = '<script src="/store-ui.js?v=20260915-globaltheme3" defer></script>';
